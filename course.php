                        ...
                        <div class="table_section padding_infor_info">
                           <div class="table-responsive-sm">
                              <table class="table table-striped">
                                 ...
                                 <tbody>
                                    <?php
                                    $data = getFromData("SELECT course.id_course,course.name_course,department.name_department,lecturer.first_name,lecturer.last_name
                                   FROM course JOIN department
                                   ON course.id_department=department.id_department
                                    JOIN lecturer ON lecturer.id_lecturer=course.id_lecturer;");
                                    foreach ($data as $result) {

                                       echo "<tr>  <td>" . $result["id_course"] . "</td>" .
