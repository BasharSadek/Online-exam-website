                           ...
                           <div class="table-responsive-sm">
                              ...
                              <table class="table table-striped">
                                 ...
                                 <tbody>
                                    ...
                                    FROM lecturer 
                                    JOIN account ON account.id_account=lecturer.id_account;");

                                    foreach ($data as $result) {
                                       $idLe = $result["id_lecturer"];
                                       echo "<tr>  
                                         <td>" . $result["id_lecturer"] . "</td>" .
                                          ...
                                          . " <td>" . $result["mobile"] . "</td>"
                                          . "<td>";
                                       $data2 = getFromData("SELECT course.name_course FROM course WHERE course.id_lecturer=' $idLe'");
                                       foreach ($data2 as $result2) {
                                          echo   $result2['name_course'] . '<br>';
                                       }
                                       echo "</td></tr>";
                                    }
