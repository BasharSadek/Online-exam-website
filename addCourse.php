                              ...
                              <table class="table table-striped">
                                 <form method="post">
                                    ...
                                    <tr>
                                       ...
                                       <td><select value="1" name="number" required>
                                             <?php

                                             $data = getFromData("SELECT department.id_department,department.name_department
                                                  FROM department; ");
                                             foreach ($data as $result) {
                                                echo "<option value=\" " . $result["id_department"] . "\" name=\" number\" class=\"optionAddExam\">" . $result["name_department"] . " </option>";
                                             }
                                             ?>
                                          </select></td>
                                    </tr>
                                    <tr>
                                       <td><b>ID & Lecturer Name</b></td>
                                       <td><select value="1" name="numLect" required class=" TableAddInput">
                                             <?php

                                             $data2 = getFromData("SELECT lecturer.id_lecturer,lecturer.first_name,lecturer.last_name
                                           FROM lecturer;");
                                             foreach ($data2 as $result) {
                                                echo "<option value=\" " . $result["id_lecturer"] . "\" name=\" numLect\">" .
                                    ...
                                    <tr>
                                       ...
                                       <td> <select value="1" name="num" required class=" TableAddInput">
                                             ...
                                             foreach ($data as $result) {
                                                echo '<option value="' . $result["id_course"] . '" name=" num" > ' .
                                                   $result["name_course"] .  '</option>';
                                             }
                                             ?>
                                          </select></td>
                                    <tr>
...
if (isset($_POST['add'])) {
   $name = $_POST['name'];
   $num = $_POST['number'];
   $numLect = $_POST['numLect'];
   connToData("INSERT INTO course VALUES(NULL,'$name','$num','$numLect');");
   echo '<script>alert("Done Saved");</script>';
   // $sql = "INSERT INTO course VALUES(NULL,'Math1',1);";
}
if (isset($_POST['update'])) {
   $name = $_POST['name'];
   $num = $_POST['num'];
   connToData("UPDATE course SET course.name_course='$name'
