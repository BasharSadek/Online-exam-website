                              ...
                              <table class="table table-striped">
                                 <form method="post">
                                    <thead>
                                       ...
                                       <tr>
                                          <td>
                                             <p><b>Department selection</b> </p>
                                          </td>
                                          <td> <select value="1" name="num" required class=" TableAddInput">
                                                <?php

                                                $data = getFromData("SELECT department.id_department,department.name_department FROM department; ");
                                                foreach ($data as $result) {
                                                   echo '<option value="' . $result["id_department"] . '" name=" num" > ' .
                                                      $result["name_department"] .  '</option>';
                                                }
                                                ?>
                                             </select></td>
                                       <tr>
...
if (isset($_POST['add'])) {
   $name = $_POST['name'];
   connToData("INSERT INTO  department VALUES(NULL,'$name');");
   echo '<script>alert("Done Saved");</script>';
}
if (isset($_POST['update'])) {
   $name = $_POST['name'];
   $num = $_POST['num'];
   connToData("UPDATE department SET department.name_department='$name'
   WHERE department.id_department=$num ;");
