                           ...
                           <div class="table-responsive-sm">
                              <form method="post">
                                 <table class="table table-striped">
                                    ...
                                    <tbody>
                                       <?php
                                       $data = getFromData("SELECT exam.id_Exam,exam.name,exam.Exam_date,exam.hour,exam.duration,course.name_course
                                    FROM exam JOIN course
                                    ON exam.id_course=course.id_course;");
...
if (isset($_POST['delete'])) {
   $num = $_POST['chech'];
   connToData("DELETE FROM exam WHERE exam.id_Exam='$num';");
}
?>