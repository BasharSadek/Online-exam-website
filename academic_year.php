                        ...
                        <div class="table_section padding_infor_info">
                           <div class="table-responsive-sm">
                              <table class="table table-striped">
                                 ...
                                 <tbody>
                                    <?php
                                    $data = getFromData("SELECT academic_year.name_Year, (SELECT COUNT(student.id_student)
                                    FROM student  WHERE student.id_year=academic_year.id_Academic_year)
                                       AS 'num',FORMAT(AVG(mark.Amount),2) AS 'avg'
                                      ...
                                      GROUP BY academic_year.id_Academic_year");
